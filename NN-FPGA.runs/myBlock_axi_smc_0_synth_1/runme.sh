...
HD_PWD='E:/MTP2/neuralNetwork-master/Tut-8/NN-FPGA/NN-FPGA.runs/myBlock_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myBlock_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myBlock_axi_smc_0.tcl
