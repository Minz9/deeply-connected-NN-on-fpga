...
HD_PWD='E:/MTP2/neuralNetwork-master/Tut-8/NN-FPGA/NN-FPGA.runs/myBlock_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myBlock_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myBlock_rst_ps7_0_100M_0.tcl
