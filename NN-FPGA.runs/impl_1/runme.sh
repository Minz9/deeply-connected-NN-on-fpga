...
HD_PWD='E:/MTP2/neuralNetwork-master/Tut-8/NN-FPGA/NN-FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myBlock_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myBlock_wrapper.tcl -notrace
